...
{-
    ...
    Although we haven't completly managed to build a fast version of sudoku solver (exc2)
    that only uses the datatype constrnt. We did get a general idea about pros of 
