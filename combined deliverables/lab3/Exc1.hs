...
------
Assignment:
The lecture notes of this week discuss the notions of satisfiability, tautology, 
contradiction, logical entailment and logical equivalence for formulas of propositional 
logic. The lecture notes give a definition of satisfiable, for objects of type Form.
...
-- | logical entailment: B logically entails A is true if and only if it is necessary 
-- that if all of the elements of B are true, then A is true.
...
testCont, testTaut, testEntail, testEquiv :: Bool
